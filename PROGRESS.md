...
- `pnpm test`：通过（parser 21/21，validator 69/69，web 13/13；总计 103/103）
- `pnpm -r build`：通过
...
1. parser 深化：继续做 run 级混排；脚注 / 尾注、题注 / 交叉引用已完成基础解析与有效性校验。
