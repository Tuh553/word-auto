...
1. Web 体验：批量检测、带批注 docx 导出、进一步打磨报告与预览联动细节（如 run 级局部高亮与双向滚动体验）。
